...
public extension OA.HUD {
    @available(iOS 13.0, *)
    static var scene: UIWindowScene? = nil
    ...
    @discardableResult static func show(icon: Icon = .loading, title: String? = nil, description: String? = nil, animated: Bool = true, completion: ((VC) -> ())? = nil) -> OA.HUD.Type {
        ...
        if #available(iOS 13.0, *) {
            ...
            guard let scene = Self.scene else { return OA.HUD.self }
    ...
    static func hide(delay: TimeInterval = 0, animated: Bool = true, completion: (() -> ())? = nil) {
    ...
    @discardableResult static func view(icon: Icon, title: String? = nil, description: String? = nil) -> OA.HUD.Type {
