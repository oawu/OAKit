...
public extension OA {
    class Request: NSObject, URLSessionDelegate, URLSessionDataDelegate, OA_Http_Delegate {
        ...
        @discardableResult private func _done(code: UInt16, data: Any) -> Self {
            ...
            let _done: Done = .init(code: code, data: data)
        ...
        // method
        @discardableResult public func get(done: ((Done) -> ())? = nil) -> Self {
            self.method(.get)
                .done(done: done)
                .send()
        }
        ...
        @discardableResult public func post(done: ((Done) -> ())? = nil) -> Self {
            self.method(.post)
                .done(done: done)
                .send()
        }
        ...
        @discardableResult public func put(done: ((Done) -> ())? = nil) -> Self {
            self.method(.put)
                .done(done: done)
                .send()
        }
        ...
        @discardableResult public func delete(done: ((Done) -> ())? = nil) -> Self {
            self.method(.delete)
                .done(done: done)
                .send()
        }
