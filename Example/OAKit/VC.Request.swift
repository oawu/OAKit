...
extension VC {
    class Request: UITableViewController {
        ...
        private func getSample_0_12() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").get { print($0) } }
        private func getSample_0_13() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").post { print($0) } }
        private func getSample_0_14() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").put { print($0) } }
        private func getSample_0_15() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").delete { print($0) } }
        
        private func getSample_0_16() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).get { print($0) } }
        private func getSample_0_17() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).post { print($0) } }
        private func getSample_0_18() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).put { print($0) } }
        private func getSample_0_19() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).delete { print($0) } }

        private func getSample_0_20() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).get { print($0) } }
        private func getSample_0_21() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).post { print($0) } }
        private func getSample_0_22() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).put { print($0) } }
        private func getSample_0_23() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).delete { print($0) } }
        ...
        private func getSample_0_28() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").get {} }
        private func getSample_0_29() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").post {} }
        private func getSample_0_30() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").put {} }
        private func getSample_0_31() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").delete {} }
        ...
        private func getSample_0_36() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.get() }
        private func getSample_0_37() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.post() }
        private func getSample_0_38() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.put() }
        private func getSample_0_39() { OA.Request(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.delete() }
        ...
        private func getSample_1_12() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").get { (model: Model) in print(model) } }
        private func getSample_1_13() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").post { (model: Model) in print(model) } }
        private func getSample_1_14() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").put { (model: Model) in print(model) } }
        private func getSample_1_15() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw("aaaaaa").delete { (model: Model) in print(model) } }
        
        private func getSample_1_16() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).get { (model: Model) in print(model) } }
        private func getSample_1_17() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).post { (model: Model) in print(model) } }
        private func getSample_1_18() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).put { (model: Model) in print(model) } }
        private func getSample_1_19() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw(Raw(title: "OA")).delete { (model: Model) in print(model) } }

        private func getSample_1_20() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).get { (model: Model) in print(model) } }
        private func getSample_1_21() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).post { (model: Model) in print(model) } }
        private func getSample_1_22() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).put { (model: Model) in print(model) } }
        private func getSample_1_23() { OA.API(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").raw([Raw(title: "OA"), Raw(title: "OB")]).delete { (model: Model) in print(model) } }
        ...
        private func getSample_1_28() { OA.API<Model>(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.get() }
        private func getSample_1_29() { OA.API<Model>(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.post() }
        private func getSample_1_30() { OA.API<Model>(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.put() }
        private func getSample_1_31() { OA.API<Model>(url: self.url).progress { print($0) }.header(key: "h", val: "aa").query(key: "a", val: "1").query(key: "b", val: "?1@2 3+%").form(key: "c", val: "2").form(key: "d", val: "?1@2 3+%").before { print(1) }.before { print(2) }.after { print(3) }.after { print(4) }.delete() }
